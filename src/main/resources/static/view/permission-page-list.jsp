...
<body class="hold-transition skin-purple sidebar-mini">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="all-order-manage-list.html">资源权限</a></li>
                        ...
                        <div class="table-box">
                            ...
                            <div class="pull-left">
                                <div class="form-group form-inline">
                                    <div class="btn-group">
                                        <button type="button" class="btn btn-default" title="新建" onclick="location.href='${pageContext.request.contextPath}/view/permission-add.jsp'"><i class="fa fa-file-o"></i> 新建</button>
									...
									<c:forEach items="${pageInfo.list }" var="permission">
										<tr>
	                                        ...
	                                        <td class="text-center">
	                                            <button type="button" class="btn bg-olive btn-xs" onclick="location.href='${pageContext.request.contextPath}/permission/findById?id=${permission.id}'">详情</button>
	                                            <button type="button" class="btn bg-olive btn-xs" onclick="location.href='${pageContext.request.contextPath}/findById?id=${permission.id}'">添加权限</button>
	                                        </td>
	                                    </tr>	
    ...
    <script>
        ...
        function changePageSize(){
        	...
        	//向服务器发送请求，改变每页显示条数
        	location.href="${pageContext.request.contextPath}/permission/permissionList?page=1&size="+pageSize;
        }
    </script>
</body>
