...
<body class="hold-transition skin-purple sidebar-mini">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="all-order-manage-list.html">视频角色</a></li>
                        ...
                        <div class="table-box">
                            ...
                            <div class="pull-left">
                                <div class="form-group form-inline">
                                    <div class="btn-group">
                                        <button type="button" class="btn btn-default" title="新建" onclick="location.href='${pageContext.request.contextPath}/view/role-add.jsp'"><i class="fa fa-file-o"></i> 新建</button>
									...
									<c:forEach items="${pageInfo.list }" var="role">
										<tr>
	                                        ...
	                                        <td class="text-center">
	                                            ...
	                                            <button type="button" class="btn bg-olive btn-xs" onclick="location.href='${pageContext.request.contextPath}/role/findRoleByIdAllPermission?id=${role.id}'">添加权限</button>
	                                        </td>
	                                    </tr>	
                            ...
                            <div class="pull-left">
                                <div class="form-group form-inline">
                                    <div class="btn-group">
                                        ...
                                        <button type="button" class="btn btn-default" title="删除" onclick="delet_confirm()"><i class="fa fa-trash-o"></i> 删除</button>
    ...
    <script>
        ...
        function changePageSize(){
        	...
        	//向服务器发送请求，改变每页显示条数
        	location.href="${pageContext.request.contextPath}/role/roleList?page=1&size="+pageSize;
        }
        function delet_confirm(){
        	
        	var r = confirm("你确定要删除吗？")
           	if(r == true) {
           		location.href="${pageContext.request.contextPath}/view/role-add.jsp"
           		return true;
        	}else{
        		return false;
        	}
